...
CREATE TABLE IF NOT EXISTS `mad_scientist`.`champ_12_20` (
  `champion` TEXT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `mad_scientist`.`partida_item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mad_scientist`.`partida_item` (
  `id_partida` INT NOT NULL,
  `id_item` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id_partida`, `id_item`),
  INDEX `fk_partida_item_items_idx` (`id_item` ASC) VISIBLE,
  CONSTRAINT `fk_partida_item_items`
    FOREIGN KEY (`id_item`)
    REFERENCES `mad_scientist`.`items` (`item_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_partida_item_partidas1`
    FOREIGN KEY (`id_partida`)
    REFERENCES `mad_scientist`.`partidas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
